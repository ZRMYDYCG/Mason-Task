        ...
        <div className="flex items-center">
          ...
          {iconList.map((item, index) => {
            return (
              <div
                key={index}
                className="mr-3 flex h-[30px] w-8 cursor-pointer items-center justify-center rounded-md"
                style={{
            ...
            <div className="flex flex-wrap items-center">
              {cloneFileList.map(item => {
                return (
                  <div
                    key={item.id}
                    className="relative mr-5 flex h-[108px] w-[100px] cursor-pointer flex-col items-end justify-center hover:bg-[#f4f5f7]"
                  ...
                  >
                    <div className="flex w-full justify-center">{renderFile(item)}</div>
                    <div className="mt-2 w-full text-center">{item.name}</div>
                    {item.hovered ? (
                      <>
