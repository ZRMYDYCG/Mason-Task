...
const TaskSetting = (props: Props) => {
  ...
  const items: MenuProps['items'] = [
    ...
    },
    {
      ...
      label: (
        <div className="flex items-center">
          <div className="h-4 w-4 bg-[#fffae6]"></div>
    ...
    },
    {
      ...
      label: (
        <div className="flex items-center">
          <div className="h-4 w-4 bg-[#e5f5ff]"></div>
    ...
    },
    {
      ...
      label: (
        <div className="flex items-center">
          <div className="h-4 w-4 bg-[#ecffe5]"></div>
    ...
    },
    {
      ...
      label: (
        <div className="flex items-center">
          <div className="h-4 w-4 bg-[#ffeaee]"></div>
    ...
    },
    {
      ...
      label: (
        <div className="flex items-center">
          <div className="h-4 w-4 bg-[#f6ecff]"></div>
    ...
    },
    {
      ...
      label: (
        <div className="flex items-center">
          <div className="h-4 w-4 bg-[#f3f3f3]"></div>
